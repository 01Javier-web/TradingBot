...
La suite automatizada debe permanecer en verde antes de aceptar cambios en la lógica de riesgo, investigación o paper trading.
...
La suite de paper trading incluye escenarios deterministas para señales contrarias, stop-loss, límites de riesgo y kill switch. Las sesiones pueden serializarse a JSON determinista y sus eventos incluyen timestamp de mercado para auditoría cronológica. Cada sesión produce eventos secuenciales y una auditoría estructural para facilitar trazabilidad y revisión.
